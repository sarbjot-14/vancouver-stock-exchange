...
public static class OrderExtensions
{
    ...
    public static Order ToOrder(this OrderRequestDto orderRequestDto)
    {
        ...
        return new Order { account_id = orderRequestDto.account_id, order_class = orderRequestDto.order_class, symbol = orderRequestDto.symbol, side = orderRequestDto.side, quantity = orderRequestDto.quantity, type = orderRequestDto.type, duration = orderRequestDto.duration, price = orderRequestDto.price, stop = orderRequestDto?.stop, trailing = orderRequestDto?.trailing };
